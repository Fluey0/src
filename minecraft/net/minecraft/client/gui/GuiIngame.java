...
public class GuiIngame extends Gui
{
    ...
    {
        ScaledResolution var2 = new ScaledResolution(this.getMc(), this.getMc().displayWidth, this.getMc().displayHeight);
        int var3 = var2.getScaledWidth();
        int var4 = var2.getScaledHeight();
        this.getMc().entityRenderer.setupOverlayRendering();
        GlStateManager.enableBlend();

        if (Minecraft.isFancyGraphicsEnabled())
        {
            this.func_180480_a(this.getMc().thePlayer.getBrightness(p_175180_1_), var2);
        }
        else
        {
        ...
        ItemStack var5 = this.getMc().thePlayer.inventory.armorItemInSlot(3);

        if (this.getMc().gameSettings.thirdPersonView == 0 && var5 != null && var5.getItem() == Item.getItemFromBlock(Blocks.pumpkin))
        {
            this.func_180476_e(var2);
        }

        if (!this.getMc().thePlayer.isPotionActive(Potion.confusion))
        {
            float var6 = this.getMc().thePlayer.prevTimeInPortal + (this.getMc().thePlayer.timeInPortal - this.getMc().thePlayer.prevTimeInPortal) * p_175180_1_;
        ...
        if (this.getMc().playerController.enableEverythingIsScrewedUpMode())
        {
        ...
        this.getMc().getTextureManager().bindTexture(icons);
        GlStateManager.enableBlend();
        ...
        GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
        this.getMc().mcProfiler.startSection("bossHealth");
        this.renderBossHealth();
        this.getMc().mcProfiler.endSection();

        if (this.getMc().playerController.shouldDrawHUD())
        {
        ...
        if (this.getMc().thePlayer.getSleepTimer() > 0)
        {
            this.getMc().mcProfiler.startSection("sleep");
            GlStateManager.disableDepth();
            GlStateManager.disableAlpha();
            var11 = this.getMc().thePlayer.getSleepTimer();
        ...
        if (this.getMc().thePlayer.isRidingHorse())
        {
            this.func_175186_a(var2, var11);
        }
        else if (this.getMc().playerController.gameIsSurvivalOrAdventure())
        {
            this.func_175176_b(var2, var11);
        }

        if (this.getMc().gameSettings.heldItemTooltips && !this.getMc().playerController.enableEverythingIsScrewedUpMode())
        {
            this.func_175182_a(var2);
        }
        else if (this.getMc().thePlayer.func_175149_v())
        {
            this.field_175197_u.func_175263_a(var2);
        }

        if (this.getMc().isDemo())
        {
            this.func_175185_b(var2);
        }

        if (this.getMc().gameSettings.showDebugInfo)
        {
        ...
        {
            this.getMc().mcProfiler.startSection("overlayMessage");
        ...
        {
            this.getMc().mcProfiler.startSection("titleAndSubtitle");
        ...
        Scoreboard var12 = this.getMc().theWorld.getScoreboard();
        ScoreObjective var13 = null;
        ScorePlayerTeam var15 = var12.getPlayersTeam(this.getMc().thePlayer.getName());
        ...
        this.getMc().mcProfiler.startSection("chat");
        this.persistantChatGUI.drawChat(this.updateCounter);
        this.getMc().mcProfiler.endSection();
        GlStateManager.popMatrix();
        var16 = var12.getObjectiveInDisplaySlot(0);

        if (this.getMc().gameSettings.keyBindPlayerList.getIsKeyPressed() && (!this.getMc().isIntegratedServerRunning() || this.getMc().thePlayer.sendQueue.func_175106_d().size() > 1 || var16 != null))
        {
    ...
    {
        if (this.getMc().func_175606_aa() instanceof EntityPlayer)
        {
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            this.getMc().getTextureManager().bindTexture(widgetsTexPath);
            EntityPlayer var3 = (EntityPlayer)this.getMc().func_175606_aa();
    ...
    {
        this.getMc().mcProfiler.startSection("jumpBar");
        this.getMc().getTextureManager().bindTexture(Gui.icons);
        float var3 = this.getMc().thePlayer.getHorseJumpPower();
        short var4 = 182;
    ...
    {
        this.getMc().mcProfiler.startSection("expBar");
        this.getMc().getTextureManager().bindTexture(Gui.icons);
        int var3 = this.getMc().thePlayer.xpBarCap();
        int var6;

        if (var3 > 0)
        {
            short var4 = 182;
            int var5 = (int)(this.getMc().thePlayer.experience * (float)(var4 + 1));
        ...
        if (this.getMc().thePlayer.experienceLevel > 0)
        {
            this.getMc().mcProfiler.startSection("expLevel");
            int var9 = 8453920;
            String var10 = "" + this.getMc().thePlayer.experienceLevel;
    ...
    {
        this.getMc().mcProfiler.startSection("toolHighlight");
    ...
    {
        this.getMc().mcProfiler.startSection("demo");
        String var2 = "";

        if (this.getMc().theWorld.getTotalWorldTime() >= 120500L)
        {
            var2 = I18n.format("demo.demoExpired", new Object[0]);
        }
        else
        {
            var2 = I18n.format("demo.remainingTime", new Object[] {StringUtils.ticksToElapsedTime((int)(120500L - this.getMc().theWorld.getTotalWorldTime()))});
        }
    ...
    {
        if (this.getMc().gameSettings.showDebugInfo && !this.getMc().thePlayer.func_175140_cp() && !this.getMc().gameSettings.field_178879_v)
        {
            return false;
        }
        else if (this.getMc().playerController.enableEverythingIsScrewedUpMode())
        {
            if (this.getMc().pointedEntity != null)
            {
                return true;
            }
            else
            {
                if (this.getMc().objectMouseOver != null && this.getMc().objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
                {
                    BlockPos var1 = this.getMc().objectMouseOver.func_178782_a();

                    if (this.getMc().theWorld.getTileEntity(var1) instanceof IInventory)
                    {
                        return true;
                    }
                }
    ...
    private void func_180477_d(ScaledResolution p_180477_1_)
    {
        if (this.getMc().func_175606_aa() instanceof EntityPlayer)
        {
            EntityPlayer var2 = (EntityPlayer)this.getMc().func_175606_aa();
            ...
            this.getMc().mcProfiler.startSection("armor");
            int var22;
            int var23;
            ...
            this.getMc().mcProfiler.endStartSection("health");
            int var25;
            int var26;
            int var27;
            ...
            if (var34 == null)
            {
                this.getMc().mcProfiler.endStartSection("food");
            ...
            {
                this.getMc().mcProfiler.endStartSection("mountHealth");
            ...
            this.getMc().mcProfiler.endStartSection("air");

            if (var2.isInsideOfMaterial(Material.water))
            {
                var23 = this.getMc().thePlayer.getAir();
    ...
    private void renderBossHealth()
    {
        if (BossStatus.bossName != null && BossStatus.statusBarTime > 0)
        {
            ...
            FontRenderer var1 = this.getMc().fontRendererObj;
            ScaledResolution var2 = new ScaledResolution(this.getMc(), this.getMc().displayWidth, this.getMc().displayHeight);
            int var3 = var2.getScaledWidth();
            short var4 = 182;
    ...
    private void func_180476_e(ScaledResolution p_180476_1_)
    {
        ...
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        GlStateManager.disableAlpha();
        this.getMc().getTextureManager().bindTexture(pumpkinBlurTexPath);
    ...
    private void func_180480_a(float p_180480_1_, ScaledResolution p_180480_2_)
    {
        ...
        WorldBorder var3 = this.getMc().theWorld.getWorldBorder();
        float var4 = (float)var3.getClosestDistance(this.getMc().thePlayer);
        ...
        this.getMc().getTextureManager().bindTexture(vignetteTexPath);
    ...
    private void func_180474_b(float p_180474_1_, ScaledResolution p_180474_2_)
    {
        ...
        this.getMc().getTextureManager().bindTexture(TextureMap.locationBlocksTexture);
        TextureAtlasSprite var3 = this.getMc().getBlockRendererDispatcher().func_175023_a().func_178122_a(Blocks.portal.getDefaultState());
    ...
    private void func_175184_a(int p_175184_1_, int p_175184_2_, int p_175184_3_, float p_175184_4_, EntityPlayer p_175184_5_)
    {
        ...
        if (var6 != null)
        {
            ...
            this.itemRenderer.func_175030_a(this.getMc().fontRendererObj, var6, p_175184_2_, p_175184_3_);
        }
    }
    ...
    public void updateTick()
    {
        ...
        if (this.getMc().thePlayer != null)
        {
            ItemStack var1 = this.getMc().thePlayer.inventory.getCurrentItem();
    ...
    {
        return this.getMc().fontRendererObj;
    }
