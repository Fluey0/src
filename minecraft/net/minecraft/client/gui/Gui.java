...
public class Gui
{
    ...
    protected static float zLevel1;
    ...
    public static void drawRect1(double d, float f, double e, double g, final int color) {
        if (d < e) {
        ...
        GlStateManager.color(var7, var8, var9, var6);
        var11.startDrawingQuads();
        var11.addVertex(d, g, 0.0);
        var11.addVertex(e, g, 0.0);
        var11.addVertex(e, f, 0.0);
        var11.addVertex(d, f, 0.0);
        var10.draw();
        GlStateManager.func_179098_w();
        GlStateManager.disableBlend();
    }
    
    public static void drawRect2(double d, float f, double e, double g, final int color) {
        if (d < e) {
            final float var5 = (float)d;
            d = e;
            e = var5;
    ...
    public static void drawGradientRect1(final int left, final int top, final int right, final int bottom, final int startColor, final int endColor) {
        final float var7 = (startColor >> 24 & 0xFF) / 255.0f;
        final float var8 = (startColor >> 16 & 0xFF) / 255.0f;
        final float var9 = (startColor >> 8 & 0xFF) / 255.0f;
        final float var10 = (startColor & 0xFF) / 255.0f;
        ...
        var16.startDrawingQuads();
        var16.func_178960_a(var8, var9, var10, var7);
        var16.addVertex(right, top, Gui.zLevel1);
        var16.addVertex(left, top, Gui.zLevel1);
        var16.func_178960_a(var12, var13, var14, var11);
        var16.addVertex(left, bottom, Gui.zLevel1);
        var16.addVertex(right, bottom, Gui.zLevel1);
        var15.draw();
        GlStateManager.shadeModel(7424);
        GlStateManager.disableBlend();
        GlStateManager.enableAlpha();
    ...
    public static void drawString(final FontRenderer fontRendererIn, final String text, final float x, final float y, final int color) {
