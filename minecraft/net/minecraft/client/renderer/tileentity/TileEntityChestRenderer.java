...
import me.itech.module.modules.ChestESP;
...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer {
	...
	private static final ResourceLocation textureTrapped = new ResourceLocation(
	...
	public void func_180538_a(TileEntityChest p_180538_1_, double p_180538_2_,
			double p_180538_4_, double p_180538_6_, float p_180538_8_,
			int p_180538_9_) {
		int var10;
		...
		if (!p_180538_1_.hasWorldObj()) {
			...
			if (var11 instanceof BlockChest && var10 == 0) {
				((BlockChest) var11).checkForSurroundingChests(
						p_180538_1_.getWorld(),
						p_180538_1_.getPos(),
						p_180538_1_.getWorld().getBlockState(
								p_180538_1_.getPos()));
				var10 = p_180538_1_.getBlockMetadata();
			}
		...
		if (p_180538_1_.adjacentChestZNeg == null
				&& p_180538_1_.adjacentChestXNeg == null) {
			ModelChest var15;

			if (p_180538_1_.adjacentChestXPos == null
					&& p_180538_1_.adjacentChestZPos == null) {
			...
			GlStateManager.translate((float) p_180538_2_,
					(float) p_180538_4_ + 1.0F, (float) p_180538_6_ + 1.0F);
			...
			GlStateManager.translate(-0.5F, -0.5F, -0.5F);
			float var13 = p_180538_1_.prevLidAngle
					+ (p_180538_1_.lidAngle - p_180538_1_.prevLidAngle)
					* p_180538_8_;
			float var14;
	...
	public void renderTileEntityAt(TileEntity p_180535_1_, double p_180535_2_,
			double p_180535_4_, double p_180535_6_, float p_180535_8_,
			int p_180535_9_) {
		this.func_180538_a((TileEntityChest) p_180535_1_, p_180535_2_,
				p_180535_4_, p_180535_6_, p_180535_8_, p_180535_9_);

		if (Storm.theClient.moduleManager.getModule(ChestESP.class).getState()) {
			GL11.glPushMatrix();
        	{
