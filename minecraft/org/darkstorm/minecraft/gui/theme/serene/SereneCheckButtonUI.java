...
public class SereneCheckButtonUI extends AbstractComponentUI<CheckButton>
{
    private final SereneTheme theme;
    
    SereneCheckButtonUI(final SereneTheme theme) {
    ...
    protected void renderComponent(final CheckButton button) {
        ...
        if (button.isSelected()) {
            GL11.glColor4f(0.25f, 0.75f, 1.0f, 0.5f);
            GL11.glBegin(7);
            GL11.glVertex2d(2.0, 2.0);
            GL11.glVertex2d((double)(size + 2), 2.0);
            GL11.glVertex2d((double)(size + 2), (double)(size + 2));
