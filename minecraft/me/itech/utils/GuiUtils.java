...
public class GuiUtils
{
  ...
  public void drawTag(String s, double d, double d1, double d2) {
    ...
    fontRendererObj.drawString(s, -fontRendererObj.getStringWidth(s) / 2, byte0, color);
    fontRendererObj.drawString(s, -fontRendererObj.getStringWidth(s) / 2, byte0, color);
    GL11.glDisable(3042);
    GL11.glEnable(2929);
    GL11.glEnable(2896);
