...
public final class OGLRender
{
    ...
    public static Color getRandomColor(final int saturationRandom, final float luminance) {
        final float randomFloat = MathUtils.getRandom();
        final float saturation = (MathUtils.getRandom(saturationRandom) + 1000) / saturationRandom + 1000.0f;
        return Color.getHSBColor(randomFloat, saturation, luminance);
    }
    
    public static void draw3DString(final FontRenderer fontRenderer, final String text, final float x, final float y, final float z, final int color) {
        GL11.glPushMatrix();
    ...
    public static void draw3DStringCentered(final FontRenderer fontRenderer, final String text, final float x, final float y, final float z, final int color) {
        GL11.glPushMatrix();
        GL11.glTranslated((double)x, (double)y, (double)z);
        GL11.glNormal3f(0.0f, 1.0f, 0.0f);
        GL11.glRotatef(-RenderManager.playerViewY, 0.0f, 1.0f, 0.0f);
    ...
    public static void drawTexturedModalRect(final int par1, final int par2, final int par3, final int par4, final int par5, final int par6) {
        ...
        final WorldRenderer var9 = Tessellator.instance.getWorldRenderer();
        var9.startDrawingQuads();
        var9.addVertexWithUV(par1 + 0, par2 + par6, 0.0, (par3 + 0) * 0.00390625f, (par4 + par6) * 0.00390625f);
        var9.addVertexWithUV(par1 + par5, par2 + par6, 0.0, (par3 + par5) * 0.00390625f, (par4 + par6) * 0.00390625f);
        var9.addVertexWithUV(par1 + par5, par2 + 0, 0.0, (par3 + par5) * 0.00390625f, (par4 + 0) * 0.00390625f);
        var9.addVertexWithUV(par1 + 0, par2 + 0, 0.0, (par3 + 0) * 0.00390625f, (par4 + 0) * 0.00390625f);
        var9.draw();
    }
    ...
    public static void renderCrosses(final Box box) {
        GL11.glBegin(1);
        GL11.glVertex3d(box.maxX, box.maxY, box.maxZ);
        GL11.glVertex3d(box.maxX, box.minY, box.minZ);
        GL11.glVertex3d(box.maxX, box.maxY, box.minZ);
    ...
    public static void updateScaledResolution() {
        OGLRender.scaledResolution = new ScaledResolution(Minecraft.getMinecraft(), Minecraft.getMinecraft().displayWidth, Minecraft.getMinecraft().displayHeight);
    }
    
    public static ScaledResolution getScaledResolution() {
        return OGLRender.scaledResolution;
    }
    
    public static void prepareScissorBox(final float x, final float y, final float x2, final float y2) {
        updateScaledResolution();
        final int factor = OGLRender.scaledResolution.getScaleFactor();
        GL11.glScissor((int)(x * factor), (int)((OGLRender.scaledResolution.getScaledHeight() - y2) * factor), (int)((x2 - x) * factor), (int)((y2 - y) * factor));
    }
}
